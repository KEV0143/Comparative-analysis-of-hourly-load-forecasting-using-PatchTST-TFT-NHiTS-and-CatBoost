...
<h1>⚡ Comparative Analysis of Hourly Load Forecasting</h1>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Darts-ML-orange?style=flat-square" alt="Darts">
  <img src="https://img.shields.io/badge/Pandas-Data-green?style=flat-square&logo=pandas" alt="Pandas">
</p>

<div align="center" style="margin: 40px 0; padding: 20px; border-top: 1px solid #eaeaea; border-bottom: 1px solid #eaeaea;">

<h3>Научное сотрудничество</h3>
<p style="max-width: 700px; margin: 0 auto 15px;">
Авторы готовы к научному сотрудничеству с университетами, датацентрами, энергетическими компаниями и производственными предприятиями в области применения вышеописанных моделей (в т.ч. трансформеров) для задач прогнозирования нагрузки.
</p>
<p style="max-width: 700px; margin: 0 auto 15px;">
Готовы к проведению пилотирования моделей в производственных и энергетических компаниях с последующим внедрением.
</p>
<p style="margin: 20px 0 0;">
<a href="mailto:Dzgoev_Alan@mail.ru" style="text-decoration: none; color: #0366d6; font-weight: 600;">
Dzgoev_Alan@mail.ru
</a>
</p>
<h1></h1>
